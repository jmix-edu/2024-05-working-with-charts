package com.company.jmixpmflowbase.view.dishesraiting;
...
@Route(value = "dishes-raiting-view", layout = MainView.class)
@ViewController("DishesRaitingView")
@ViewDescriptor("dishes-raiting-view.xml")
public class DishesRaitingView extends StandardView {
